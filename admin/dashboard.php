...
<head>
	...
	<title>House Rental Portal | Admin Dashboard</title>
...
?>
											...
											<a href="manage-ads.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Listed Area</div>
												</div>
											</div>
											<a href="manage-area.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
