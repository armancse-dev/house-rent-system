...
<?php $sql = "SELECT tblhouses.*,tblbrands.BrandName,tblbrands.id as bid  from tblhouses join tblbrands on tblbrands.id=tblhouses.HouseBrand";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Find A House </h5>
          </div>
...
<option value="Lake Road">Lake Road</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-house" aria-hidden="true"></i> Recently Listed Houses</h5>
          </div>
